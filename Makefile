windows: libpd.dll lua51.dll
	gcc -O2 -c -I./libpd/libpd_wrapper/ -I./libpd/pure-data/src/ -I./lua/ -I./portaudio/include \
		-o luapd_wrapper.o luapd_wrapper.c
	gcc -shared -L/c/MinGW/bin/ -L/c/MinGW/lib/ -L./portaudio/lib/.libs/ -o luapd_wrapper.dll luapd_wrapper.o  \
		libpd.dll lua51.dll libportaudio-2.dll
macosx:
